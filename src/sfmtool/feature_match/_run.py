...
from .._sfmr_naming import _generate_image_descriptor
...
def _generate_output_path(
    ...
    # The same image descriptor a generated `.sfmr` name gets, so the two
    # artifacts of one run describe their inputs the same way.
    descriptor = _generate_image_descriptor(image_paths)
