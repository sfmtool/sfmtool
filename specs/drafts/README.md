...
| [sfmr-optional-thumbnails.md](sfmr-optional-thumbnails.md) | [formats/sfmr-file-format.md](../formats/sfmr-file-format.md), [cli/reconstruction/xform/xform-command.md](../cli/reconstruction/xform/xform-command.md), [core/reconstruction/edited-reconstruction.md](../core/reconstruction/edited-reconstruction.md), [gui/multi-panel-image-browser.md](../gui/multi-panel-image-browser.md), [gui/camera-views.md](../gui/camera-views.md) | `.sfmr` version 11 with optional per-image thumbnails (`has_thumbnails`) and an empty `workspace.absolute_path` meaning none recorded; thumbnails optional in memory and never filled in on load; the viewer building display thumbnails from the photographs; `sfm xform --drop-thumbnails`, `--drop-patch-bitmaps`, `--add-thumbnails`, `--add-patch-bitmaps` and `--minimal`, the shorthand that writes the smallest complete file. |
