...
| [track-at-pixel.md](track-at-pixel.md) | New; builds on [core/bench/editable-track.md](../core/bench/editable-track.md) | One operation that builds a high-quality track centred on a pixel of one image, or refuses naming the stage that failed and what it measured; the evidence it may draw on; and the leave-one-track-out harness in [`scripts/track_at_pixel/`](../../scripts/track_at_pixel/README.md) that judges candidate algorithms against ground truth. |
