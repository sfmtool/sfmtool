...
| [sfm-explorer-editing.md](sfm-explorer-editing.md) | [gui/scene-graph.md](../gui/scene-graph.md), [gui/action-log.md](../gui/action-log.md), [gui/mcp-server.md](../gui/mcp-server.md); files new `core/reconstruction/shared-columns.md`, `gui/document-model.md`, `gui/edit-history.md`, `gui/saving.md`, `gui/edits/` | Editing a loaded reconstruction in place under value semantics: per-column copy-on-write sharing, a history of values with undo/redo and a History panel, saving, edit families, and the open row-level-edit problem for ten-million-observation track columns. The umbrella draft for the arc; steps are deleted from it as they ship. |
| [sfm-explorer-editing-overlay.md](sfm-explorer-editing-overlay.md) | Part 4 of [sfm-explorer-editing.md](sfm-explorer-editing.md); files into `core/reconstruction/shared-columns.md` | An edited reconstruction as an immutable shared base plus a deleted set and an addition point set: every edit is delete-and-re-add, indexes stay stable while the base lives, and the plain CSR form is materialised only for an algorithm, a save or a size threshold, becoming the next base. |
