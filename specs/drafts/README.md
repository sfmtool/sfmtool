...
| [kdf-constellation-affine-refit-amendment.md](kdf-constellation-affine-refit-amendment.md) | [core/features/kdf-constellation-query.md](../core/features/kdf-constellation-query.md) | Reporting each found image's affine as a least-squares fit over the RANSAC consensus, Gaussian-weighted about the patch centre, in place of the best three-point model as drawn; and the measurements that chose it over a staged (progressive) query. |
