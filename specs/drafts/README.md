...
| [move-camera-edit.md](move-camera-edit.md) | Part 5 of [sfm-explorer-editing.md](sfm-explorer-editing.md); [gui/camera-views.md](../gui/camera-views.md), [gui/viewport-navigation.md](../gui/viewport-navigation.md), [gui/viewport-hud.md](../gui/viewport-hud.md), [gui/edit-history.md](../gui/edit-history.md), [gui/mcp-server.md](../gui/mcp-server.md) | Moving one image's pose by locking the camera to the viewport in camera view: every navigation input moves the pending pose, points hold still as the alignment signal with a live residual readout, an optional re-triangulation preview that is per-frame or on-rest by a measured budget, and one version at release with the observed tracks re-solved. |
