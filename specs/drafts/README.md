...
| [bundle-adjust-free-and-held-points-amendment.md](bundle-adjust-free-and-held-points-amendment.md) | [core/geometry/bundle-adjustment.md](../core/geometry/bundle-adjustment.md), [core/reconstruction/point-estimation.md](../core/reconstruction/point-estimation.md), [formats/sfmr-file-format.md](../formats/sfmr-file-format.md) | Three point kinds for the adjustment: free points whose finite-or-direction representation is re-decided every round at a noise-floor angle and can cross either way; ranged points whose distance from a reference is fixed (infinity included) while the triangulation owns their direction; and held points whose coordinate is fixed while their observations still constrain the cameras; `w = 0` then reports an estimate rather than an instruction. |
