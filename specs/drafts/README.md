...
| [switch-camera-model.md](switch-camera-model.md) | [gui/camera-intrinsics.md](../gui/camera-intrinsics.md), [gui/mcp-server.md](../gui/mcp-server.md), [gui/edits/switch-camera-model.md](../gui/edits/switch-camera-model.md), [core/reconstruction/switch-camera-model.md](../core/reconstruction/switch-camera-model.md) | Showing a camera model switch as a proposal before it is applied: the proposal in the Camera Intrinsics panel compared against the current model there and in the Image Detail overlay, `propose_camera_model`, and the proposal form of `switch_camera_model`; the direct switch and the spline refit it amends are built. The Kerry Park fisheyes are the motivating case. |
