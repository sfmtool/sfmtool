...
| [track-view.md](track-view.md) | [gui/point-track-detail.md](../gui/point-track-detail.md), [gui/track-edit.md](../gui/track-edit.md), [gui/bench.md](../gui/bench.md), [gui/scene-graph.md](../gui/scene-graph.md), [gui/panel-layout.md](../gui/panel-layout.md), [core/bench/bench.md](../core/bench/bench.md) | One Track View panel in place of Point Track and Track Edit: an Edit checkbox that reads the bench's activation, a committed track shown with it clear and the active bench item edited with it ticked, no bench list in the panel, a Scene tree double-click that activates an item and raises the panel, a bench that can hold items with none active, and a saved layout naming either retired panel refused whole. |
