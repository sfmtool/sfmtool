...
|----------|--------|----------|
| [multi-camera-bundle-adjustment-amendment.md](multi-camera-bundle-adjustment-amendment.md) | [core/geometry/bundle-adjustment.md](../core/geometry/bundle-adjustment.md), [core/reconstruction/bundle-adjust.md](../core/reconstruction/bundle-adjust.md) | Bundle adjustment over several cameras: a camera list and a per-image camera index in the kernel, one lens block per camera in the reduced system, releases decided per camera, a per-camera report, and a model-aware in-front test for directions. |
