...
| [bench-track-in-3d-viewer.md](bench-track-in-3d-viewer.md) | [gui/bench.md](../gui/bench.md), [core/bench/editable-track.md](../core/bench/editable-track.md), [gui/point-cloud-rendering.md](../gui/point-cloud-rendering.md); Part 7 of [sfm-explorer-track-editing.md](sfm-explorer-track-editing.md) | Drawing the bench's active track in the 3D viewer as depth-aware scene geometry (frame, in-plane centre dot, normal arrow, one mark per observation where its keypoint's ray meets the plane) and taking hold of it there: slide, resize and turn as in Image Detail, plus the two a photograph cannot say, an offset along the normal and a tilt that stops 80 degrees from any observation. A reduced figure with no normal for a track at infinity. Four implementation steps. |
