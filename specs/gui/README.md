...
| [edit-history.md](edit-history.md) | The edit history: the cursor undo and redo walk, the truncation a new edit performs, the per-step point maps the selection follows, and the Edit menu and its shortcuts. |
