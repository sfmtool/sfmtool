...
| [gui-goto-point.md](gui-goto-point.md) | Go to Point: type or paste a point index or a `pt3d_<hash>_<index>` ID to select that point, switching reconstructions when the ID names a different one. |
