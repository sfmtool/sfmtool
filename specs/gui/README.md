...
| [edit-history.md](edit-history.md) | The edit history: the cursor undo and redo walk, the truncation a new edit performs, the per-step point maps the selection follows, the Edit menu and its shortcuts, and the History panel that lists a node's versions and jumps the cursor to one of them. |
