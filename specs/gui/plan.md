...
- [user-experience.md](user-experience.md) — Vision and design
- [architecture.md](architecture.md) — Technology stack and crate structure
- [point-cloud-rendering.md](point-cloud-rendering.md) — Point rendering and EDL
- [camera-views.md](camera-views.md) — Frustum wireframes and image projection
- [viewport-navigation.md](viewport-navigation.md) — Navigation controls
- [viewport-hud.md](viewport-hud.md) — In-viewport display controls (proposed)
...
- Single 3D point selection with track visualization, including the Point
  Track Detail panel (see [point-track-detail.md](point-track-detail.md))
- Patch/surfel rendering (Point Track Detail patch tiles + point-cloud patch
  rendering; see [patch-rendering.md](patch-rendering.md))
...
- Image animation & playback (Space/arrows/brackets, minibar transport,
  camera-view fly-through; see [image-animation.md](image-animation.md))
- Cross-panel hover highlighting (see [cross-panel-hover.md](cross-panel-hover.md))
- FOV zoom in camera view mode (scroll / Ctrl+drag / pinch adjust FOV instead
  of dollying; see [viewport-navigation.md](viewport-navigation.md))
- Viewport HUD: every 3D display control lives in a collapsible in-viewport
  ...
  (see [viewport-hud.md](viewport-hud.md))
...
3. **FOV zoom gesture** — Dedicated input binding for FOV adjustment during
   ...
   [viewport-navigation.md](viewport-navigation.md#fov-zoom))
4. ~~**Adaptive grid** — Update grid to work at any scale.~~ Done.
5. ~~**Adaptive clip planes** — Reversed-Z infinite far projection with adaptive near plane.~~ Done. See [adaptive-clip-and-grid.md](adaptive-clip-and-grid.md).
...
- ~~Animation mode (play through images as sequence)~~ Done — see
  [image-animation.md](image-animation.md).
...
See [architecture.md](architecture.md#performance-design) for GPU
