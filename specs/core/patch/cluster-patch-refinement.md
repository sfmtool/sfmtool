...
> `specs/cli/image-feature/cluster-patches-command.md`. Additions: the output path is
...
category, spec to live at `specs/cli/image-feature/cluster-patches-command.md`:
