...
| [remove-observation.md](remove-observation.md) | Removing one observation from a track, in either observation mode and without reading a photograph: the remainder re-triangulated, one sighting left as a bearing at the frame's own angular size, and none leaving no point. |
