...
| [editable-track.md](editable-track.md) | The editable track: its observations with their provenance, per-stage measurements and verdicts, the two representations it passes through, the evaluation that measures it at either and the transitions between them, and the steps that grow, judge, split and finally commit one as a point. |
