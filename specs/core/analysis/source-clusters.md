...
The seed relaxation's fill-in
([seed-relaxation.md](../geometry/seed-relaxation.md)) is the caller: it runs
the join once per member against the selection the member was drawn from, then
brings the candidates back one band at a time, coarsest first.
