...
| [refit.md](refit.md) | Fitting a camera of one model to a camera of another over the angles where the source is trusted: one linear solve for the spline models, a small nonlinear fit for the COLMAP polynomials, and a report of what the target cannot represent. |
