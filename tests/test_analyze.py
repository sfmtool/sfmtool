...
def test_analyze_requires_mode(sfmrfile_reconstruction_with_17_images):
...
def test_analyze_coviz(sfmrfile_reconstruction_with_17_images):
...
def test_analyze_images(sfmrfile_reconstruction_with_17_images):
...
def test_analyze_metrics(sfmrfile_reconstruction_with_17_images):
...
def test_analyze_metrics_with_range(sfmrfile_reconstruction_with_17_images):
...
def test_analyze_mutually_exclusive_flags(sfmrfile_reconstruction_with_17_images):
...
def test_analyze_range_without_metrics(sfmrfile_reconstruction_with_17_images):
