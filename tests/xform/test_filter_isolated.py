...
def test_remove_isolated_points_median(seoul_bull_sfmr_only_deprecated, tmp_path):
...
def test_remove_isolated_points_percentile(seoul_bull_sfmr_only_deprecated, tmp_path):
