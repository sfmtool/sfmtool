...
def test_filter_by_reprojection_error_basic(seoul_bull_sfmr_only_deprecated, tmp_path):
...
def test_filter_by_reprojection_error_strict(seoul_bull_sfmr_only_deprecated, tmp_path):
