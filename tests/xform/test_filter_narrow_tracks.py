...
def test_remove_narrow_tracks_basic(seoul_bull_sfmr_only_deprecated, tmp_path):
...
def test_remove_narrow_tracks_90_degrees(seoul_bull_sfmr_only_deprecated, tmp_path):
...
def test_remove_narrow_tracks_small_radians(seoul_bull_sfmr_only_deprecated, tmp_path):
