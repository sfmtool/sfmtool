...
def test_remove_narrow_tracks_basic(seoul_bull_sfmr_only, tmp_path):
...
def test_remove_narrow_tracks_strict_threshold(seoul_bull_sfmr_only, tmp_path):
...
def test_remove_narrow_tracks_lenient_threshold(seoul_bull_sfmr_only, tmp_path):
...
def test_remove_narrow_tracks_preserves_tracks(seoul_bull_sfmr_only, tmp_path):
...
def test_remove_narrow_tracks_90_degrees(seoul_bull_sfmr_only, tmp_path):
...
def test_remove_narrow_tracks_small_radians(seoul_bull_sfmr_only, tmp_path):
