...
def test_remove_short_tracks_length_one(seoul_bull_sfmr_only, tmp_path):
...
def test_remove_short_tracks_min_threshold(seoul_bull_sfmr_only, tmp_path):
...
def test_remove_short_tracks_high_threshold(seoul_bull_sfmr_only, tmp_path):
...
def test_remove_short_tracks_preserves_images(seoul_bull_sfmr_only, tmp_path):
