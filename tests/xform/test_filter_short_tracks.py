...
def test_remove_short_tracks_filter(seoul_bull_sfmr_only_deprecated, tmp_path):
...
def test_remove_short_tracks_length_one(seoul_bull_sfmr_only_deprecated, tmp_path):
...
def test_remove_short_tracks_min_threshold(seoul_bull_sfmr_only_deprecated, tmp_path):
...
def test_remove_short_tracks_high_threshold(seoul_bull_sfmr_only_deprecated, tmp_path):
