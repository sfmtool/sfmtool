...
/// Convert from sfmtool-matches-format config to COLMAP DB config.
impl From<sfmtool_matches_format::TwoViewGeometryConfig> for TwoViewGeometryConfig {
    fn from(c: sfmtool_matches_format::TwoViewGeometryConfig) -> Self {
        match c {
            sfmtool_matches_format::TwoViewGeometryConfig::Undefined => Self::Undefined,
            sfmtool_matches_format::TwoViewGeometryConfig::Degenerate => Self::Degenerate,
            sfmtool_matches_format::TwoViewGeometryConfig::Calibrated => Self::Calibrated,
            sfmtool_matches_format::TwoViewGeometryConfig::Uncalibrated => Self::Uncalibrated,
            sfmtool_matches_format::TwoViewGeometryConfig::Planar => Self::Planar,
            sfmtool_matches_format::TwoViewGeometryConfig::PlanarOrPanoramic => {
                Self::PlanarOrPanoramic
            }
            sfmtool_matches_format::TwoViewGeometryConfig::Panoramic => Self::Panoramic,
            sfmtool_matches_format::TwoViewGeometryConfig::Multiple => Self::Multiple,
            sfmtool_matches_format::TwoViewGeometryConfig::WatermarkClean => Self::WatermarkClean,
            sfmtool_matches_format::TwoViewGeometryConfig::WatermarkBad => Self::WatermarkBad,
        }
    }
}

/// Convert from COLMAP DB config to sfmtool-matches-format config.
impl From<TwoViewGeometryConfig> for sfmtool_matches_format::TwoViewGeometryConfig {
