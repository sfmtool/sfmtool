...
pub fn read_colmap_db_matches(
    ...
    Ok(MatchesData {
        metadata: MatchesMetadata {
            ...
            match_count: Some(total_matches as u32),
            cluster_count: None,
        ...
        // which requires them.
        image_dims: None,
        image_pairs: Some(sfmtool_matches_format::PairsData {
            image_index_pairs,
            match_counts,
...
fn read_tvg_from_db(
    ...
    let mut config_set: Vec<sfmtool_matches_format::TwoViewGeometryConfig> = Vec::new();
    let mut config_index_map: HashMap<sfmtool_matches_format::TwoViewGeometryConfig, u8> =
        HashMap::new();
    ...
    for pair in sorted_pairs {
        ...
        let (config, inliers, f, e, h, q, t) = match tvg_row {
            Some(row) => {
                ...
                let matches_cfg: sfmtool_matches_format::TwoViewGeometryConfig = cfg.into();
                (
                    matches_cfg,
                    &row.inlier_indexes,
                    row.f_matrix,
            ...
            None => (
                sfmtool_matches_format::TwoViewGeometryConfig::Undefined,
                &empty_inliers,
                [0.0; 9],
                [0.0; 9],
                [0.0; 9],
        ...
        let (mut q, mut t) = (q, t);
        sfmtool_matches_format::s_conjugate_relative_pose(&mut q, &mut t);
