...
//! The four tools that answer a question about one entity, and change nothing.
//!
//! (`get_scene`, the fifth read, is [`super::render::scene`] directly — it has
//! no arguments to resolve and nothing to look up.)
//!
