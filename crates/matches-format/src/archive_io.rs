...
//! Shared ZIP + zstd I/O utilities for archive-based file formats.
//!
//! This module provides the same container I/O primitives used by
//! `.sift` and `.sfmr` formats: ZIP archives with zstandard-compressed
//! entries containing JSON metadata and binary arrays.
