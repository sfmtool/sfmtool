...
//! Interactive 3D-viewport camera (orbit navigation).
//!
//! Distinct from the SfM-side [`super::intrinsics::CameraIntrinsics`]: this type
//! is the OpenGL-convention position + orientation + target-distance state used
//! by `sfm-explorer`'s 3D view for fly/orbit navigation.
